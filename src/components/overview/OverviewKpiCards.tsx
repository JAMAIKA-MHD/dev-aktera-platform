  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      {OVERVIEW_KPI_CARDS.map((card: KpiCardData) => (
        <div
          key={card.id}
          className="bg-kpi-card border border-kpi-border/40 rounded-[32px] p-6 sm:p-7 transition-all duration-200 hover:shadow-lg flex flex-col justify-between"
        >
          ...
          <div className="flex items-start justify-between gap-2 mb-5">
            ...
            <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-emerald-100/90 dark:bg-emerald-950/60 text-emerald-600 dark:text-emerald-400 text-xs sm:text-sm font-bold shrink-0">
