...
export const PlayerLanding: React.FC<PlayerLandingProps> = ({
  ...
  return (
    <div
      ...
      className="flex-1 flex flex-col px-6 py-6 overflow-y-auto bg-[#0F0F1A] text-zinc-100 justify-between h-full select-none scrollbar-thin"
    >
      ...
      >
        ...
        >
          <h2
            className="text-xl font-extrabold tracking-tight font-sans text-white uppercase"
          ...
          <p
            dir="auto"
            className="text-sm font-semibold text-zinc-300 font-sans mt-0.5"
      ...
      >
        ...
        <p
          dir="auto"
          className="text-xs text-slate-300 leading-relaxed font-sans mb-3"
        >
        ...
        <div id="teaser-prizes-list" className="grid grid-cols-2 gap-1.5 pt-1">
          {activeBrand.prizes
            ...
            .map((p, idx) => (
              <div
                key={idx}
                className="flex items-center gap-1.5 bg-[#0F0F1A]/90 px-2.5 py-2 rounded-2xl border border-[#2D2D3F]/50 text-[10px] font-semibold text-slate-200"
              >
      ...
      <form
        ...
        className="flex-1 flex flex-col gap-3.5 justify-end"
      >
        ...
        {error && (
          <motion.div
            ...
            className="p-3 bg-red-950/40 border border-red-500/20 text-red-300 rounded-2xl text-[11px] text-center font-sans font-medium leading-normal"
          >
            {error}
          </motion.div>
        )}
        ...
        <div className="flex flex-col gap-1.5">
          <label className="text-[10px] font-bold tracking-widest text-slate-400 font-mono uppercase">
          ...
          <div className="relative flex items-center">
            ...
            <input
              ...
              className="w-full bg-[#1F1F2E]/80 border border-[#2D2D3F] hover:border-slate-600 focus:border-[#6366F1] rounded-2xl pl-11 pr-4 text-sm text-slate-100 placeholder-slate-600 transition-all duration-200 min-h-12 focus:outline-none focus:ring-1 focus:ring-[#6366F1]/20 font-sans"
            />
          </div>
        </div>
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <div className="relative flex items-center">
            ...
            <input
              ...
              className="w-full bg-[#1F1F2E]/80 border border-[#2D2D3F] hover:border-slate-600 focus:border-[#6366F1] rounded-2xl pl-11 pr-4 text-sm text-slate-100 placeholder-slate-600 transition-all duration-200 min-h-12 focus:outline-none focus:ring-1 focus:ring-[#6366F1]/20 font-mono"
            />
          </div>
        </div>
        ...
        >
          <div className="mt-0.5 text-slate-400 hover:text-slate-200 transition-colors duration-150 flex-shrink-0">
            {consent ? (
              <CheckSquare
                className="w-5 h-5 text-emerald-400 fill-emerald-950/10"
                style={{ color: activeBrand.primaryColor }}
              />
            ) : (
          ...
          <div className="flex flex-col">
            ...
            >
              أوافق على المشاركة في الحملة الترويجية وتلقي الهدايا (قانون 18-07
              حماية المعطيات) 🛡️
            </span>
          </div>
        </div>
