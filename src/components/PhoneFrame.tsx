...
export const PhoneFrame: React.FC<PhoneFrameProps> = ({
  ...
  return (
    <div
      ...
      className={
        compact
          ? "relative flex items-center justify-center p-0 w-full max-w-[340px] sm:max-w-[360px] mx-auto h-full min-h-0"
    ...
    >
      ...
      <div
        ...
        className={
          compact
            ? "relative w-full h-[580px] max-h-[calc(100vh-170px)] bg-[#09090F] border-[6px] sm:border-[8px] border-[#1E1E2E] rounded-[38px] shadow-[0_0_50px_rgba(124,58,237,0.15)] flex flex-col overflow-hidden transition-all duration-300 ease-out"
