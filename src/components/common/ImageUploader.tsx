    ...
    <div className="space-y-2">
      ...
      <div className="flex flex-col gap-3 sm:flex-row">
        <button
          ...
          disabled={uploading}
          className="min-h-11 rounded-2xl border border-slate-200 bg-white px-4 py-2 text-xs font-semibold text-slate-700 transition hover:bg-slate-50 disabled:opacity-60"
        >
        ...
        {value ? (
          <button
            type="button"
            onClick={() => onChange("")}
            className="min-h-11 rounded-2xl border border-rose-200 bg-rose-50 px-4 py-2 text-xs font-semibold text-rose-700 transition hover:bg-rose-100"
          >
            <span className="inline-flex items-center gap-2">
              <X className="h-4 w-4" />
              Remove
